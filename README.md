...
The source catalogue currently includes **488 official integrations** and **229 custom integrations**. The live catalogue contains 228 custom integrations; Ingest Volume Monitor is a source-only entry pending deployment and is excluded from the live catalogue.
