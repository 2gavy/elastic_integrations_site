...
The source catalogue currently includes **488 official integrations** and **221 custom integrations**. The live catalogue has **220 custom integrations**; the Ingest Volume Monitor update below remains pending deployment.
